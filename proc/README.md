...
* `02-binavgEN4_shfbrk.py`: Bin-averages the EN4 profiles along the 200 m isobath.
* `03-calc_Nshelf-NSBC.py`: Calculates area-averaged nitrate concentrations on the shelf from the NSBC climatology.
